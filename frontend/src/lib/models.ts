...
export const CODE_GENERATION_MODEL_DESCRIPTIONS: {
  ...
  "copilot/claude-opus-5 (high effort)": {
    name: "Copilot: Claude Opus 5 (high)",
  },
  "copilot/claude-opus-5 (medium effort)": {
    name: "Copilot: Claude Opus 5 (medium)",
  },
  ...
  "copilot/gpt-6-astra (high thinking)": {
    name: "Copilot: GPT-6 Astra (high)",
  },
  "copilot/gpt-5.6-sol (high thinking)": {
    name: "Copilot: GPT 5.6 Sol (high)",
  },
  "copilot/gpt-5.6-sol (medium thinking)": {
    name: "Copilot: GPT 5.6 Sol (medium)",
  },
  "copilot/gpt-5.5 (high thinking)": { name: "Copilot: GPT 5.5 (high)" },
  "copilot/gemini-3.8-flash (high thinking)": {
    name: "Copilot: Gemini 3.8 Flash (high)",
  },
  "copilot/gemini-3.6-flash (high thinking)": {
    name: "Copilot: Gemini 3.6 Flash (high)",
  },
  "copilot/grok-4.6 (high thinking)": { name: "Copilot: Grok 4.6 (high)" },
};
