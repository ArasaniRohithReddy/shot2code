...
Evaluation dataset consists of 16 screenshots. A Python script for running shot2code on the dataset and a UI for rating outputs is included. With this set up, we can compare and evaluate various models and prompts.
...
- Run `OPENAI_API_KEY=sk-... python run_evals.py` - this runs the shot2code on the input dataset in parallel but it will still take a few minutes to complete.
